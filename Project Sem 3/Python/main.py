...
insert=Button(root,text="INSERT",bg="black",fg="white",font=("Lucida Handwriting",10),command=insert_data)
insert.place(x=20,y=300)

search=Button(root,text="SEARCH",bg="black",fg="white",font=("Lucida Handwriting",10),command=search_data)
search.place(x=86,y=300)

update=Button(root,text="UPDATE",bg="black",fg="white",font=("Lucida Handwriting",10),command=update_data)
update.place(x=155,y=300)

delete=Button(root,text="DELETE",bg="black",fg="white",font=("Lucida Handwriting",10),command=delete_data)
delete.place(x=226,y=300)
